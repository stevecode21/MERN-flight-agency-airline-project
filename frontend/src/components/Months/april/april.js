...
export default  class April extends   Component {
    state={
        ...
        fecha:[],
        lunes:json[3].setDate1,
        jueves:json[3].setDate2,
        ...
        <td>Dia :Lunes</td>
        {
          this.state.lunes.map(fecha=>(
            ...
            {fecha}
              ...
              <button  type="button" className="botones" onClick={() => saveLunes(fecha,"lunes","Abril")} > <i className="fas fa-check-square iconos" ></i></button>
              </td>
        ...
        <td>Dia :Jueves</td>
        {
          this.state.jueves.map(fecha=>(
            ...
            {fecha}
              ...
              <button type="button"  className="botones"  onClick={() => saveJueves(fecha,"Jueves","Abril")} > <i className="fas fa-check-square iconos" ></i></button>
              </td>
