...
export default  class January extends   Component {
    state={
        ...
        fecha:[],
        lunes:json[0].setDate1,
        jueves:json[0].setDate2,
        ...
        <td>Dia :Lunes</td>
        {
          this.state.lunes.map(fecha=>(
            ...
            {fecha}
              ...
              <button  type="button" className="botones" onClick={() => saveLunes(fecha,"lunes","Enero")} > <i className="fas fa-check-square iconos" ></i></button>
              </td>
        ...
        <td>Dia :Jueves</td>
        {
          this.state.jueves.map(fecha=>(
            ...
            {fecha}
              ...
              <button type="button"  className="botones" onClick={() => saveJueves(fecha,"Jueves","Enero")} > <i className="fas fa-check-square iconos" ></i></button>
              </td>
