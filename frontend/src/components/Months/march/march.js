...
export default  class March extends   Component {
    state={
        ...
        fecha:[],
        lunes:json[2].setDate1,
        jueves:json[2].setDate2,
        ...
        <td>Dia :Lunes</td>
        {
          this.state.lunes.map(fecha=>(
            ...
            {fecha}
              ...
              <button  type="button" className="botones" onClick={() => saveLunes(fecha,"lunes","Marzo")} > <i className="fas fa-check-square iconos" ></i></button>
              </td>
        ...
        <td>Dia :Jueves</td>
        {
          this.state.jueves.map(fecha=>(
            ...
            {fecha}
              ...
              <button type="button" className="botones"  onClick={() => saveJueves(fecha,"Jueves","Marzo")} > <i className="fas fa-check-square iconos" ></i></button>
              </td>
