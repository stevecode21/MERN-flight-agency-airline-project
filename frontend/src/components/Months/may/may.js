...
export default  class May extends   Component {
    state={
        ...
        fecha:[],
        lunes:json[4].setDate1,
        jueves:json[4].setDate2,
        ...
        <td>Dia :Lunes</td>
        {
          this.state.lunes.map(fecha=>(
            ...
            {fecha}
              ...
              <button  type="button" className="botones" onClick={() => saveLunes(fecha,"lunes","Mayo")} > <i className="fas fa-check-square iconos" ></i></button>
              </td>
        ...
        <td>Dia :Jueves</td>
        {
          this.state.jueves.map(fecha=>(
            ...
            {fecha}
              ...
              <button type="button"   className="botones" onClick={() => saveJueves(fecha,"Jueves","Mayo")} > <i className="fas fa-check-square iconos" ></i></button>
              </td>
